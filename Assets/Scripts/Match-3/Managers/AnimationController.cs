...
{
    // Coroutine que realiza a troca de itens entre duas peças com uma animação suave.
    ...
    // Coroutine que anima a aparição de uma nova peça escalando-a do zero até seu tamanho original.
